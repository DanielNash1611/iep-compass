...
export const jordanDemoScenario: ExampleScenario = {
  ...
  iepExcerpt: '',
  summary:
    'Synthetic IEP and assignment photos ready for the Ollama fallback reader.',
  taskText: '',
...
export function createJordanDemoSources(): {
  ...
  const iepAttachment = buildDemoAttachment({
    ...
    notes: [
      ...
      'Use the Ollama fallback action to read this image and create a new review draft.',
