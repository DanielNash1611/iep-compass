...
- Graphic organizer accommodation for planning written responses and labs.
...
- Graphic organizer accommodation before drafting written responses.`,
    taskText: `Students are taking an ELA assessment with a reading passage and a written response prompt. The class has one period to finish reading, planning, and writing. The teacher wants to know which accommodations may apply without changing what the assessment is measuring.`,
  },
  {
...
- Graphic organizer accommodation when a worksheet has multiple written parts.`,
    taskText: `A student takes a photo of a social studies worksheet before class starts. The worksheet has several short-answer boxes, a map to label, and directions spread across the page. The student wants to check what accommodation to ask for before the work begins.`,
  },
  {
